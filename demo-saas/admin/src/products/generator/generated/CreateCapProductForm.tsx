...
type CreateCapProductFormDetailsFragment = Omit<GQLCreateCapProductFormDetailsFragment, "image"> & {
    image: GQLFinalFormFileUploadDownloadableFragment | null;
};
type FormValues = CreateCapProductFormDetailsFragment;
interface FormProps {
...
export function CreateCapProductForm({ onCreate, type }: FormProps) {
    ...
    const handleSubmit = async (formValues: FormValues, form: FormApi<FormValues>, event: FinalFormSubmitEvent) => {
        const output = { ...formValues, description: formValues.description ?? null, category: formValues.category ? formValues.category.id : null, availableSince: formValues.availableSince ?? null, image: formValues.image ? formValues.image.id : null, };
