import { ExcelExportButton, IRow, Table, useExportDisplayedTableData } from "@comet/admin-core";
...
storiesOf("@comet/admin-core/table", module).add("Export Displayed Table Data", () => <Story />);
