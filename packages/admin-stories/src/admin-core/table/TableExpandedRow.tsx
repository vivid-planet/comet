import { ITableHeadRowProps, ITableRowProps, Table, TableBodyRow, TableColumns, TableHeadColumns } from "@comet/admin-core";
...
storiesOf("@comet/admin-core/table", module).add("Expanded Row", () => <Story />);
