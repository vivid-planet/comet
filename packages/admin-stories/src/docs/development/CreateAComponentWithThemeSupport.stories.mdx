...
Material-UI supports overriding of styles and default props of components using the theme.  
Using the same method it should also be possible to override all CometAdmin components.
...
/*
 * Add your components Props and ClassKey types to the Material-UI type-definitions.
 */
