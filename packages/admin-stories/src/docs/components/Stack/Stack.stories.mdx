...
It can be combined with the Material UI components [`Link`](https://v4.mui.com/api/link/) and [`Button`](https://v4.mui.com/api/button/) using their `component` prop.
More infos on this functionality can be found in the [Routing Libraries section of the Material UI Docs](https://v4.mui.com/guides/composition/#routing-libraries).
