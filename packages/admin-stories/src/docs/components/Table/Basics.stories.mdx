...
See [Sorting page](/story/docs-components-table-sorting--page#sorting)

### headerExcel & renderExcel & formatForExcel

See [Excel Export page](/story/docs-components-table-excel-export--page#excel-export-and-custom-rendered-columns)
