...
In this case, you can use a plain HTML input combined with a React state.
...
-   mutation in adjacent file .gql.ts
-   client.mutate instead of useMutation() hook
-   input object for mutated values
