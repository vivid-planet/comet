...
<Canvas>
    <Story id="stories-components-toolbar--empty" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-toolbar--automatic-title-item" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-toolbar--title-item" />
</Canvas>

### ToolbarTitleItem internationalization

<Canvas>
    <Story id="stories-components-toolbar--localized-title-item" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-toolbar--breadcrumbs" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-toolbar--back-button" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-toolbar--fill-space-left" />
</Canvas>

<Canvas>
    <Story id="stories-components-toolbar--fill-space-right" />
</Canvas>

<Canvas>
    <Story id="stories-components-toolbar--fill-space-middle" />
</Canvas>

<Canvas>
    <Story id="stories-components-toolbar--fill-space-middle-2" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-toolbar--toolbaritem" />
</Canvas>

The `ToolbarItem` can be easily mixed up with other drop in compoents like `ToolbarAutomaticTitleItem`

<Canvas>
    <Story id="stories-components-toolbar--toolbaritem-mixing-with-other-components" />
</Canvas>

### ToolbarActions

<Canvas>
    <Story id="stories-components-toolbar--toolbaractions-one-action" />
</Canvas>

<Canvas>
    <Story id="stories-components-toolbar--toolbaractions-two-actions" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-toolbar--custom-title-h1" />
</Canvas>

<Canvas>
    <Story id="stories-components-toolbar--custom-title-h2" />
</Canvas>

One can also use totally custom components in it.

<Canvas>
    <Story id="stories-components-toolbar--custom-title-h3" />
</Canvas>

The Toolbar expands automatically if it needs more space

<Canvas>
    <Story id="stories-components-toolbar--custom-title-h4" />
</Canvas>

### Custom Back Button

<Canvas>
    <Story id="stories-components-toolbar--custom-back-button" />
</Canvas>

### Search - Final Form Search

<Canvas>
    <Story id="stories-components-toolbar--search-final-form" />
</Canvas>

### Search - Final Form Search Custom Icon

<Canvas>
    <Story id="stories-components-toolbar--search-final-form-custom-icon" />
</Canvas>

### Search - Final Form Input

<Canvas>
    <Story id="stories-components-toolbar--search-final-form-input" />
</Canvas>

### Search - Autocomplete

<Canvas>
    <Story id="stories-components-toolbar--search-autocomplete" />
</Canvas>

### SplitButton Save

<Canvas>
    <Story id="stories-components-toolbar--splitbutton-save" />
</Canvas>

### Save

<Canvas>
    <Story id="stories-components-toolbar--save" />
</Canvas>
