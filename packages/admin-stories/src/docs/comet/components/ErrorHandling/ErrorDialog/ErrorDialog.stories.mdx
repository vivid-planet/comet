...
<Canvas>
    <Story id="stories-components-errorhandling-errordialog--manual-error-dialog" />
</Canvas>

### Automatic Error Dialog on graphQL Error

<Canvas>
    <Story id="stories-components-errorhandling-errordialog--automatic-error-on-graphql-error" />
</Canvas>
