...
<Meta title="Docs/Rich Text/Setup" />
...
When your persistance layer supports storing JSON-objects, stringifying is not needed. This is the implementation in Comet-Cms.
