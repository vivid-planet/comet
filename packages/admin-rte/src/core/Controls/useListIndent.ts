            ...
            ? [
                  {
                      ...
                      tooltipText: intl.formatMessage({ id: "cometAdminCore.rte.controls.listIndent.right.tooltip", defaultMessage: "Tab" }),
                  },
                  {
                      ...
                      tooltipText: intl.formatMessage({ id: "cometAdminCore.rte.controls.listIndent.left.tooltip", defaultMessage: "Shift+Tab" }),
                  },
              ]
            : [];
