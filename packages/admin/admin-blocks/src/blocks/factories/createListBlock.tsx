...
import { Checkbox, FormControlLabel, IconButton, Tooltip, Typography } from "@material-ui/core";
                                                    ...
                                                    <AdminComponentStickyHeader>
                                                        <BlockListHeader>
                                                            ...
                                                            <BlockListHeaderActionContainer>
                                                                {selectedCount > 0 && (
                                                                    <>
                                                                        <IconButton onClick={deleteAllSelectedBlocks}>
                                                                            <Delete />
                                                                        </IconButton>
                                                                        <IconButton onClick={copySelectedBlocks}>
                                                                            <Copy />
                                                                        </IconButton>
                                                                    </>
                                                                )}
                                                                <IconButton onClick={() => pasteBlock(0)}>
                                                                    <Paste />
                                                                </IconButton>
                                                            </BlockListHeaderActionContainer>
                                                        </BlockListHeader>
