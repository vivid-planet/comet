...
const FolderInnerMenu = React.forwardRef(
    ({ id, handleClose }: FolderInnerMenuProps, ref): React.ReactElement => {
        const intl = useIntl();
...
const FileInnerMenu = React.forwardRef(
    ({ file, handleClose }: FileInnerMenuProps, ref): React.ReactElement => {
        const intl = useIntl();
