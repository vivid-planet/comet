...
import { Button, IconButton, Link, List, ListItem, ListItemIcon, ListItemSecondaryAction, ListItemText, makeStyles } from "@material-ui/core";
        ...
        >
            <List className={classes.list} disablePadding>
                <ListItem key="refresh" className={classes.listItemHeader} divider>
                    <Button size="small" endIcon={<ReloadIcon />} onClick={() => refetch({ id: fileId })}>
                    ...
                    return (
                        <ListItem key={file.id} divider>
                            ...
                            <ListItemSecondaryAction>
                                <IconButton component={Link} underline="none" href={href}>
                                    <LinkIcon />
                                </IconButton>
                                <IconButton component={Link} underline="none" href={href} target="_blank">
                                    <OpenNewTabIcon />
                                </IconButton>
                            </ListItemSecondaryAction>
                        </ListItem>
