...
export const createUsePage: CreateUsePage = <RootBlocks extends RootBlocksInterface, PageType extends string>({
    rootBlocks,
...
>({
    ...
    return function usePage({ pageId, onValidationFailed }: UsePageProps): UsePageApi<PageState<GQLEditPageQuery, RootBlocks, PageType>, RootBlocks> {
        ...
        const [mutation, { loading: saving, error: saveError }] = useMutation<GQLUpdatePageMutation, GQLUpdatePageMutationVariables>(updateMutation);
        ...
        const { loading: saveConflictLoading, dialogs, checkForConflicts: checkForSaveConflict, hasConflict } = useSaveConflict<
