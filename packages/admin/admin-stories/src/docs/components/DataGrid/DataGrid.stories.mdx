...
Comet Admin contains various helpers to for using MUI X DataGrid. It works with the MIT or the Commercial version.
...
Small Component that can be placed in the Toolbar taht will show the Filter. Must be used as DataGrid child as shown in the story below.
