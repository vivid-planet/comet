...
More Info: [Snackbar in Material UI Docs](https://v4.mui.com/components/snackbars/)

<Meta title="docs/Components/Snackbar" />
...
This ensures that there is only one snackbar at a time as recommended by the [Material UI Docs](https://v4.mui.com/components/snackbars/).
...
<Canvas>
    <Story id="stories-components-snackbar-usesnackbarapi--usesnackbarapi" />
</Canvas>
...
More info on the `Snackbar` and a list of available props can be found [in the Material UI Docs](https://v4.mui.com/api/snackbar).

Only `open` is not available since the `SnackbarProvider` manages the open state.

<Canvas>
    <Story id="stories-components-snackbar-show-snackbar--show-snackbar" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-snackbar-hide-snackbar--hide-snackbar" />
</Canvas>
...
<Canvas>
    <Story id="stories-components-snackbar-undo-snackbar--undo-snackbar" />
</Canvas>
