...
import { ActionLogHeader, Button, DiffHeader, DiffViewer, InlineAlert, Loading, useStoredState } from "@comet/admin";
...
import { getCompareVersions } from "./ActionLogCompare.utils";
...
export const ActionLogCompare: FunctionComponent<ActionLogCompareProps> = ({
    ...
    const { afterVersion, beforeVersion } = getCompareVersions({ data: data, versionId1: versionId, versionId2: versionId2 });
