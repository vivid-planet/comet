...
import { buildActionLogsQuery } from "./ActionLogDialog.gql";
import type { GQLActionLogDialogFragment } from "./ActionLogDialog.gql.generated";
...
type ActionLogsQueryResult = {
    [key: string]: { nodes: GQLActionLogDialogFragment[]; totalCount: number };
};
