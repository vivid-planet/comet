...
const globalSearchQuery = gql`
    query GlobalSearch($search: String!, $scope: JSONObject) {
        fullTextSearch(search: $search, scope: $scope, limit: 10) {
            nodes {
                id
                entityName
                name
...
export function GlobalSearch() {
    ...
    const { data, loading } = useQuery<GQLGlobalSearchQuery, GQLGlobalSearchQueryVariables>(globalSearchQuery, {
