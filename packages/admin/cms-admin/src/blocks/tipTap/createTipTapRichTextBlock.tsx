...
const TipTapEditor = ({
    ...
    useEffect(() => {
        // useEditor initializes its content only on mount. A read-only host can reuse a single
        // editor instance across changing state, so sync the content whenever the state changes.
        if (!editable && editor) {
