...
import { columnInsertDataWithFiveValues as columnDataToInsert, mockBlockDataObjects } from "../__mocks__/TableBlockData.mocks";
...
describe("insertColumnDataAtIndex", () => {
    it("should insert a column with the specified column id", () => {
        ...
        const newState = insertColumnDataAtIndex(mockBlockDataObjects.default, columnDataToInsert, 0, newColumnId);
    ...
    it("should insert the correct number of rows with the automatically generated column id", () => {
        const newState = insertColumnDataAtIndex(mockBlockDataObjects.default, columnDataToInsert, 0);
