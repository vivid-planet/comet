...
const preview: Preview = {
    tags: ["autodocs"],
    decorators: [ThemeProviderDecorator, IntlDecorator, LayoutDecorator, RouterDecorator, CurrentUserProviderDecorator, ApolloDecorator, SnackbarDecorator, DndProviderDecorator],
    loaders: [
        async () => {
            await mswReady;
            return {};
