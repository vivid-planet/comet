// Adapted from https://github.com/apollographql/apollo-client/blob/release-2.x/packages/graphql-anywhere/src/graphql.ts
import {
...
import { getDirectiveInfoFromField } from "./directive";
 ...
 *
 * The default  as of graphql-anywhere is sync as of 4.0,
 * but below is an ed alternative that is async.
 * In the 5.0 version, this will be the only  again
