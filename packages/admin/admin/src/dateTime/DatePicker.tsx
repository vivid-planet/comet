    ...
    const openPickerAdornment = (
        <OpenPickerAdornment position="start" {...slotProps?.openPickerAdornment}>
            {readOnly ? (
                ...
                <OpenPickerButton onClick={() => setOpen(true)} disabled={disabled} {...slotProps?.openPickerButton}>
                    {openPickerIcon}
                </OpenPickerButton>
            )}
        </OpenPickerAdornment>
        ...
        <Root
            ...
            slotProps={{
                ...
                textField: {
                    ...
                    InputProps: {
                        // @ts-expect-error It's unclear which variant of `textField` is used here and we can't pass through the correct generic type to it
...
`) as typeof MuiDatePicker<Date, true>;
