...
import { getDateTimeValue, getIsoDateTimeString } from "./utils";
...
} & Omit<MuiDateTimePickerProps<Date, true>, "value" | "onChange" | "slotProps">;
...
export const Future_DateTimePicker = (inProps: Future_DateTimePickerProps) => {
    ...
    const dateTimeValue = getDateTimeValue(stringValue);
    ...
    return (
        <Root
            ...
            disableOpenPicker
            value={dateTimeValue}
            onChange={(date) => onChange?.(date ? getIsoDateTimeString(date) : undefined)}
            {...slotProps?.root}
            {...restProps}
            slotProps={{
                        ...
                        InputProps: {
                            ...
                            endAdornment: (
                                <>
                                    ...
                                    <ClearInputAdornment
                                        position="end"
                                        hasClearableContent={dateTimeValue !== null && !required && !disabled && !readOnly}
