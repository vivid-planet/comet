...
import * as RouterTabsStories from "./RouterTabs.stories";
import * as NestedStackSwitchWithRouterTabsStories from "./NestedStackSwitchWithRouterTabs.stories";

<Meta of={RouterTabsStories} />

# Router Tabs

The Dextinity Admin `RouterTabs` component has essentially the same functionality as `Tabs`.
...
- optionally a `forceRender` flag ([see Tabs docs for examples](?path=/docs/components-tabs-tabs--docs#tabs-and-forcerender))
...
<Canvas of={NestedStackSwitchWithRouterTabsStories.NestedStackSwitchWithRouterTabs} />
