...
import { Button, type ButtonClassKey, buttonGroupClasses, type ButtonProps } from "@mui/material";
...
/**
 * @deprecated Use `SaveButton` instead.
 * TODO: Remove this before opening PR.
 */
export function LegacySaveButton(inProps: SaveButtonProps) {
    const {
        saving = false,
        hasErrors = false,
        hasConflict = false,
