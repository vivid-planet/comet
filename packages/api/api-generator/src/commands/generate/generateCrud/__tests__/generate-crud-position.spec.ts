...
@Entity()
@CrudGenerator({ targetDirectory: __dirname, requiredPermission: "disablePermissionCheck", position: { groupByFields: ["country"] } })
...
describe("GenerateCrudPosition", () => {
    ...
    it("service should implement getPositionGroupCondition-function if configured", async () => {
        ...
        const out = await generateCrud(
            { targetDirectory: __dirname, requiredPermission: "disablePermissionCheck", position: { groupByFields: ["country"] } },
