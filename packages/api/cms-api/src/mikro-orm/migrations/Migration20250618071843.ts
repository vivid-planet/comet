...
export class Migration20250618071843 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('create table "LinkedDamFile" ("id" uuid not null, "language" text not null, "type" text check ("type" in (\'subtitles\')) not null, "source" uuid not null, "target" uuid not null, constraint "LinkedDamFile_pkey" primary key ("id"));');
