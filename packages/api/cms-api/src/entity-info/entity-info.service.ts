    ...
    async createEntityInfoView(): Promise<void> {
        ...
        for (const targetEntity of targetEntities) {
            ...
            if (typeof entityInfo === "string") {
                indexSelects.push(
                    `SELECT sub."name", sub."secondaryInformation", sub."visible", sub."id", sub."entityName", null::text[] AS "requiredPermission" FROM (${entityInfo}) sub`,
                );
            } else {
        ...
        indexSelects.push(`SELECT "PageTreeNodeEntityInfo"."name", "PageTreeNodeEntityInfo"."secondaryInformation", "PageTreeNodeEntityInfo"."visible", "PageTreeNodeDocument"."documentId"::text "id", "type" "entityName", null::text[] AS "requiredPermission"
