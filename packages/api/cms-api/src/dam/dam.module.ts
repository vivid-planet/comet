...
import { DamFileSubtitle } from "./files/entities/file-subtitle.entity";
...
export class DamModule {
    static register({
        ...
        return {
            module: DamModule,
            imports: [MikroOrmModule.forFeature([File, Folder, DamFileImage, DamFileSubtitle, ImageCropArea]), BlobStorageModule],
            providers: [
                damConfigProvider,
                DamItemsResolver,
                DamItemsService,
