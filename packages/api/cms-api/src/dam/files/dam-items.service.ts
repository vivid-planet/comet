...
import { DamFileListPositionInput } from "./dto/file.args";
...
export class DamItemsService {
    ...
    async getDamItemPosition(id: string, type: DamItemTypeLiteral, args: DamFileListPositionInput): Promise<number> {
