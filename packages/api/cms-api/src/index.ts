...
export { ScopedEntity } from "./common/decorators/scoped-entity.decorator";
...
export { createUserPermissionsJwtStrategy } from "./user-permissions/auth/jwt.strategy";
export { createUserPermissionsStaticAuthedUserStrategy } from "./user-permissions/auth/static-authed-user.strategy";
export { AffectedContentScope } from "./user-permissions/decorators/affected-content-scope.decorator";
export { AffectedEntity } from "./user-permissions/decorators/affected-entity.decorator";
