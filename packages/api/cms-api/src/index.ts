...
export { createAuthResolver } from "./auth/auth.resolver";
...
export { CurrentUser as CurrentUserDto } from "./auth/dto/current-user.dto";
...
export { CurrentUserService as CurrentUserServiceInterface } from "./auth/interfaces/current-user-service.interface";
