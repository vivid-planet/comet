    ...
    return (
        <React.Fragment>
            ...
            <Dialog open={dialogOpen} onClose={handleNoClick}>
                <DialogTitle>
                    <FormattedMessage
                        id="cometAdminCore.deleteMutation.promptDelete"
                ...
                <DialogActions>
                    <Button onClick={handleYesClick} color="primary" autoFocus={true} variant="contained">
                        <Typography variant="button">
                            <FormattedMessage id="cometAdminCore.generic.yes" defaultMessage="Yes" />
                        </Typography>
                    </Button>
                    <Button onClick={handleNoClick} color="primary">
                        <Typography variant="button">
                            <FormattedMessage id="cometAdminCore.generic.no" defaultMessage="No" />
                        </Typography>
                    </Button>
                </DialogActions>
            </Dialog>
