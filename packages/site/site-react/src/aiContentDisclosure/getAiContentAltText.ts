 ...
 */
export function getAiContentAltText({ aiContentType, description }: { aiContentType?: AiContentType | null; description?: string | null }): string {
    if (!aiContentType) {
        return description ?? "";
    }

    const prefix = aiContentType === "Generated" ? `[AI-generated]` : `[AI-modified]`;
