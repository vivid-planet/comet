...
exports.createRewrites = void 0;
var createRedirects_1 = require("./createRedirects");
var createRewrites = function () { return __awaiter(void 0, void 0, void 0, function () {
    var apiUrl, rewrites, _a, _b, _c, redirect, source, destination, e_1_1;
    var _d, e_1, _e, _f;
        ...
        switch (_g.label) {
            case 0:
                ...
                if (!apiUrl) {
                    ...
                    return [2 /*return*/, { redirects: [], rewrites: [] }];
                }
                rewrites = [];
                _g.label = 1;
            case 1:
                _g.trys.push([1, 6, 7, 12]);
                _a = true, _b = __asyncValues((0, createRedirects_1.getRedirects)());
                _g.label = 2;
            ...
            case 3:
                ...
                try {
                    ...
                    if (source && destination && source.toLowerCase() === destination.toLowerCase()) {
                        rewrites.push({ source: source, destination: destination });
                    }
                }
                finally {
                    _a = true;
            ...
            case 12: return [2 /*return*/, rewrites];
        }
    });
}); };
