...
export class ProductCategoryResolver {
    ...
    @Query(() => [ProductCategory])
    async productCategories(@Args() {}: ProductCategoriesArgs, @Info() info: GraphQLResolveInfo): Promise<ProductCategory[]> {
        const where: ObjectQuery<ProductCategory> = {};
        ...
        const options: FindOptions<ProductCategory, any> = {
            populate,
        };
