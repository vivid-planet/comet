...
import { AffectedEntity, BlocksTransformerService, CurrentUser, DamImageBlock, FileUpload, GetCurrentUser, RequiredPermission, RootBlockDataScalar, gqlArgsToMikroOrmQuery, gqlSortToMikroOrmOrderBy } from "@comet/cms-api";
...
export class ProductResolver {
    ...
    async products(
    @Args()
    { search, filter, sort, offset, limit }: ProductsArgs): Promise<PaginatedProducts> {
    ...
    input: ProductInput, 
    @GetCurrentUser()
    user: CurrentUser): Promise<CreateProductPayload> {
