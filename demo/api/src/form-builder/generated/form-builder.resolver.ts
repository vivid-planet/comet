...
@RequiredPermission(["formBuilders"], { skipScopeCheck: true })
export class FormBuilderResolver {
    ...
    async formBuilders(
        @Args() { search, filter, sort, offset, limit }: FormBuildersArgs,
    ...
    async createFormBuilder(@Args("input", { type: () => FormBuilderInput }) input: FormBuilderInput): Promise<FormBuilder> {
