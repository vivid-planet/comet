...
import { ContentBlock, supportedBlocks as ContentBlockSupportedBlocks } from "@src/documents/pages/blocks/content-group.block";
...
@Injectable()
export class ContentGroupContentBlockFixtureService {
    constructor(
    ...
    async generateBlockInput(): Promise<ExtractBlockInputFactoryProps<typeof ContentBlock>> {
        const blocks: ExtractBlockInputFactoryProps<typeof ContentBlock>["blocks"] = [];

        const blockCfg: Record<keyof typeof ContentBlockSupportedBlocks, BlockFixture> = {
