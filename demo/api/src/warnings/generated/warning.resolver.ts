...
import { AffectedEntity, CurrentUser, GetCurrentUser, gqlArgsToMikroOrmQuery, RequiredPermission } from "@comet/cms-api";
...
export class WarningResolver {
    ...
    async warnings(
        ...
        where.scope = { $in: scopes }; // TODO: add filter for specific scope or unscoped
