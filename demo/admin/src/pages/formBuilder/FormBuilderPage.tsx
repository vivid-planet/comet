    ...
    return (
        <Stack topLevelTitle={intl.formatMessage({ id: "formBuilderPage.formBuilder", defaultMessage: "Form Builder" })}>
            <StackSwitch>
                <StackPage name="grid">
                        ...
                        <FormBuildersGrid
                            toolbarAction={
                                <Button startIcon={<AddIcon />} variant="contained" color="primary" onClick={() => setShowAddDialog(true)}>
                                    <FormattedMessage id="formBuilderPage.createForm" defaultMessage="Formular erstellen" />
                                </Button>
                            }
                        />
                    </MainContent>
                    <Dialog open={showAddDialog} onClose={() => setShowAddDialog(false)}>
                        <SaveBoundary onAfterSave={() => setShowAddDialog(false)}>
                            <DialogTitle>
                                <FormattedMessage id="formBuilderPage.newForm" defaultMessage="Neues Formular" />
                            </DialogTitle>
                            <DialogContent>
                                <FormBuilderAddForm />
                            </DialogContent>
                ...
                <StackPage name="edit">
                    {(id) => {
                        return <FormBuilderPreviewAndForm id={id} mode="edit" />;
                    }}
                </StackPage>
            </StackSwitch>
        </Stack>
