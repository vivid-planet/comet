    ...
    const columns: GridColDef<GQLProductsListFragment>[] = [
        ...
        { field: "description", headerName: intl.formatMessage({ id: "product.description", defaultMessage: "Description" }), width: 150 },
        {
            ...
            valueOptions: [
                ...
                { value: "Pants", label: intl.formatMessage({ id: "product.type.pants", defaultMessage: "Pants" }) },
                { value: "Jacket", label: intl.formatMessage({ id: "product.type.jacket", defaultMessage: "Jacket" }) },
                { value: "Shoes", label: intl.formatMessage({ id: "product.type.shoes", defaultMessage: "Shoes" }) },
                { value: "Socks", label: intl.formatMessage({ id: "product.type.socks", defaultMessage: "Socks" }) },
                { value: "Mug", label: intl.formatMessage({ id: "product.type.mug", defaultMessage: "Mug" }) },
                { value: "Pen", label: intl.formatMessage({ id: "product.type.pen", defaultMessage: "Pen" }) },
                { value: "Calendar", label: intl.formatMessage({ id: "product.type.calendar", defaultMessage: "Calendar" }) },
                { value: "Notebook", label: intl.formatMessage({ id: "product.type.notebook", defaultMessage: "Notebook" }) },
                { value: "Bag", label: intl.formatMessage({ id: "product.type.bag", defaultMessage: "Bag" }) },
                { value: "Watch", label: intl.formatMessage({ id: "product.type.watch", defaultMessage: "Watch" }) },
                { value: "Sunglasses", label: intl.formatMessage({ id: "product.type.sunglasses", defaultMessage: "Sunglasses" }) },
                { value: "Wallet", label: intl.formatMessage({ id: "product.type.wallet", defaultMessage: "Wallet" }) },
            ],
            width: 150,
        },
