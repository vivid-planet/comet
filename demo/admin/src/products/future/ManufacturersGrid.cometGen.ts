...
import { GQLManufacturer } from "../../graphql.generated";
...
export const ManufacturersGrid: GridConfig<GQLManufacturer> = {
    ...
    columns: [
        ...
        { type: "text", name: "addressAsEmbeddable.street", headerName: "Street" },
        { type: "number", name: "addressAsEmbeddable.streetNumber", headerName: "Street number" },
        { type: "text", name: "addressAsEmbeddable.alternativeAddress.street", headerName: "Alt-Street" },
        { type: "number", name: "addressAsEmbeddable.alternativeAddress.streetNumber", headerName: "Alt-Street number" },
    ],
};
