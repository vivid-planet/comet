...
import { PixelImageBlock } from "@comet/cms-admin";
    ...
    export function ProductForm({ id }: FormProps): React.ReactElement {
        ...
        const initialValues = React.useMemo<Partial<FormValues>>(() => data?.product
        ? {
...
<Field
            ...
            {(props) =>
                ...
                <MenuItem value="Cap"><FormattedMessage id="product.type.cap" defaultMessage="Cap" /></MenuItem>
<MenuItem value="Shirt"><FormattedMessage id="product.type.shirt" defaultMessage="Shirt" /></MenuItem>
<MenuItem value="Tie"><FormattedMessage id="product.type.tie" defaultMessage="Tie" /></MenuItem>
                </FinalFormSelect>
            }
        </Field>
