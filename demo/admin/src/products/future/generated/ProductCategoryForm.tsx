...
import {
    ...
    GQLProductCategoryFormDetailsFragment,
...
export function ProductCategoryForm({ id }: FormProps): React.ReactElement {
    ...
    const initialValues = React.useMemo<Partial<FormValues>>(
        () =>
            data?.productCategory
                ? {
                      ...filterByFragment<GQLProductCategoryFormDetailsFragment>(productCategoryFormFragment, data.productCategory),
                  }
                : {},
        [data],
    );
        ...
        >
            {() => (
                <>
                    ...
                    <MainContent>
                        <TextField required fullWidth name="title" label={<FormattedMessage id="productCategory.title" defaultMessage="Title" />} />

                        <TextField required fullWidth name="slug" label={<FormattedMessage id="productCategory.slug" defaultMessage="Slug" />} />
                    </MainContent>
                </>
            )}
        </FinalForm>
