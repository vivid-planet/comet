...
import { Field, filterByFragment, FinalForm, FinalFormSubmitEvent, Loading, TextField, useFormApiRef, useStackSwitchApi } from "@comet/admin";
...
export function ProductForm({ id, type, description, slug }: FormProps): React.ReactElement {
