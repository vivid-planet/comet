...
import { GQLManufacturersGridQuery, GQLManufacturersGridQueryVariables, GQLManufacturersGridFutureFragment, GQLCreateManufacturerMutation, GQLCreateManufacturerMutationVariables, GQLDeleteManufacturerMutation, GQLDeleteManufacturerMutationVariables } from "./ManufacturersGrid.generated";
...
const manufacturersFragment = gql `
        fragment ManufacturersGridFuture on Manufacturer {
            id
            name address { street streetNumber alternativeAddress { street streetNumber } } addressAsEmbeddable { street streetNumber alternativeAddress { street streetNumber } }
        }
    `;
