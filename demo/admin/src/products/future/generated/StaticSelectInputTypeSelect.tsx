...
import { createProductMutation, productFormFragment, productQuery, updateProductMutation } from "./StaticSelectInputTypeSelect.gql";
import {
    type GQLCreateProductMutation,
    type GQLCreateProductMutationVariables,
    type GQLProductQuery,
    type GQLProductQueryVariables,
    type GQLStaticSelectInputTypeSelectFragment,
    type GQLUpdateProductMutation,
    type GQLUpdateProductMutationVariables,
} from "./StaticSelectInputTypeSelect.gql.generated";
        ...
        >
            {() => (
                <>
                    ...
                    <FieldSet collapsible initiallyExpanded={true} title={<FormattedMessage id="product.Tenant.title" defaultMessage="Tenant" />}>
                        <Field
                            name="image"
                            isEqual={isEqual}
