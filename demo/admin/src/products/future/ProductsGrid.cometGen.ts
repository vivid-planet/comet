    ...
    columns: [
        {
            ...
            visible: (breakpoints) => breakpoints.down("md"),
        },
        { type: "text", name: "title", headerName: "Titel", minWidth: 200, maxWidth: 250, visible: (breakpoints) => breakpoints.up("md") },
        { type: "text", name: "description", headerName: "Description", visible: (breakpoints) => breakpoints.up("md") },
