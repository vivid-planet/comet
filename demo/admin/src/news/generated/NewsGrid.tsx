...
import { GQLNewsGridQuery, GQLNewsGridQueryVariables, GQLNewsGridFragment, GQLDeleteNewsMutation, GQLDeleteNewsMutationVariables } from "./NewsGrid.generated";
...
export function NewsGrid() {
    ...
    const { data, loading, error } = useQuery<GQLNewsGridQuery, GQLNewsGridQueryVariables>(newsQuery, {
        variables: {
            scope, filter: gqlFilter, search: gqlSearch, offset: dataGridProps.paginationModel.page * dataGridProps.paginationModel.pageSize, limit: dataGridProps.paginationModel.pageSize, sort: muiGridSortToGql(dataGridProps.sortModel, columns)
        },
    });
