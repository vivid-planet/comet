...
void (async () => {
    ...
    console.log("Cloning cms-admin-lang...");
    await cloneRecursively("cms-admin-lang", "cms-admin-lang");

    console.log("Cloning blocks-admin-lang...");
    await cloneRecursively("blocks-admin-lang", "blocks-admin-lang");
