"use client";
import { CookieSafe, useCookieApi/*, YouTubeVideoBlock*/ } from "@comet/site-react";
...
export const CookieSafeYouTubeVideoBlock = (props: /*ComponentProps<typeof YouTubeVideoBlock>*/any) => {
