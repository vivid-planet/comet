...
import LifecycleApi from "./lifecycle/lifecycle-api.svg";
import LifecycleAdmin from "./lifecycle/lifecycle-admin.svg";
import LifecycleFull from "./lifecycle/lifecycle-full.svg";
