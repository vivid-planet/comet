...
<font color="red">TODO How do I treat info/caution boxes here?</font>
...
| `action`         | The row context menu is generated into the actions column. Custom row actions can be added here. |
...
<font color="red">TODO Reduce these</font>
...
:::caution
The `combination` column is not yet supported in the excel export.
:::
