...
The Comet Admin `FieldSet` component is made for better structuring of big forms. It allows the user to show and hide sections of related content on a page.
