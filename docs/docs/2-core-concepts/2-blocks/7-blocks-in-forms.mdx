...
Use the [createFinalFormBlock](https://github.com/vivid-planet/dextinity/blob/main/packages/admin/cms-admin/src/blocks/form/createFinalFormBlock.tsx) helper for this:
