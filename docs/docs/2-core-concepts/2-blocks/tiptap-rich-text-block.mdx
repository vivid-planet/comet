...
- **Standardized, portable content format.** Content is stored as plain ProseMirror JSON, a well-documented format that is straightforward to render, transform, and reason about.
...
| _no server-side content validation_                                     | full API validation                                                                                  |
