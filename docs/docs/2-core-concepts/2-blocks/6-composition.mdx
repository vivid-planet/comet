...
This approach is based on the principle of [composition over inheritance](https://en.wikipedia.org/wiki/Composition_over_inheritance), which is frequently used in Dextinity.
