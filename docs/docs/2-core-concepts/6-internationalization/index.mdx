...
import comet_demo_messages_de from "../lang-compiled/dextinity-demo-lang/de.json";
import comet_demo_messages_en from "../lang-compiled/dextinity-demo-lang/en.json";
...
Comet DXP provides a set of commonly used messages exported from `@dextinity/admin`. They are already translated and can be used inside applications.
