...
In Dextinity, we call such pages "Predefined pages".
...
This section shows the changes necessary to support predefined pages in a Dextinity project.
...
[API](https://github.com/vivid-planet/dextinity/blob/main/demo/api/src/news/entities/news.entity.ts),
[Admin](https://github.com/vivid-planet/dextinity/blob/main/demo/admin/crud-generator-config.ts),
[Site](https://github.com/vivid-planet/dextinity/tree/main/demo/site/src/app/%5Blang%5D/news).
...
To do this, copy the corresponding [folder](https://github.com/vivid-planet/dextinity/tree/main/demo/api/src/documents/predefined-pages) from the Demo project.
...
To do this, copy the corresponding [folder](https://github.com/vivid-planet/dextinity/tree/main/demo/admin/src/documents/predefinedPages) from the Demo project.
The following files should be copied:
...
Create the module in `src/documents/predefinedPages`.
To do this, copy the corresponding [folder](https://github.com/vivid-planet/dextinity/tree/main/demo/site/src/documents/predefinedPages) from the Demo project.
The following files should be copied:
...
For example, consider a Dextinity website that is available in English and German.
...
1.  Copy the predefined pages [helper functions](https://github.com/vivid-planet/dextinity/tree/main/demo/site/src/middleware/predefinedPages.ts) from the Demo project

    :::warning

    Support for filtering by document type in the `paginatedPageTreeNodes` query has been added in version 7.4.0.
    Make sure your project uses Dextinity 7.4.0 or later.
