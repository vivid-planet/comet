...
For the full list of props of `ActionLogDialog` and the underlying components, see the [Action log stories in Storybook](https://storybook.comet-dxp.com/?path=/story/comet-cms-admin-action-log-action-log-dialog--default).
