...
:::info
We moved the brevo packages from the [comet-brevo-module](https://github.com/vivid-planet/comet-brevo-module) repo to the main [dextinity](https://github.com/vivid-planet/dextinity) monorepo.
