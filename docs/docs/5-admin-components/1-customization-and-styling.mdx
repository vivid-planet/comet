...
Dextinity Admin components are designed to be used similarly to MUI components.
...
For instructions on how to build components that support these features, see [Creating customizable Admin components](/docs/dextinity-core-development/creating-customizable-admin-components).
