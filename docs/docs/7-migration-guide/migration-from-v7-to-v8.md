...
## Optional: Migrate local development to a setup with authentication

This guide helps to add local authentication so that it works like the [demo application](../1-getting-started/3-demo-application.md#structure-of-the-demo-application).
...
Remove all instances of `USE_AUTHPROXY`/`useAuthProxy` so that local dev and deployed instances just work the same. [This Comet-PR](https://github.com/vivid-planet/comet-starter/pull/1201/changes) might be helpful.
