...
function isLocaleOptions(value: any): value is LocaleOptions {
...
const messages: Record<LocaleOptions, Record<string, string>> = {
    en: {
...
export const IntlDecorator: Decorator = (fn, context) => {
    const { locale: selectedLocale = LocaleOptions.English } = context.globals;
