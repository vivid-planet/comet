...
4. use one of Dextinity Admin's paging actions to generate a `pagingInfo` object inside `resolveTableData()`
...
Dextinity Admin supports multiple types of pagination:
