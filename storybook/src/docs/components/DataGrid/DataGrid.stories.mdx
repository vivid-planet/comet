...
<Canvas>
    <Story id="stories-components-datagrid--usedatagridexcelexport" />
</Canvas>
...
This component is a button with a context menu, that can also display of the number of items selected. It has been designed to enable CRUD actions for batch processing and general actions for a DataGrid table. It is normally placed in a toolbar above the DataGrid.
...
<Canvas>
    <Story id="stories-components-datagrid--crudmoreactionsmenu" />
</Canvas>
