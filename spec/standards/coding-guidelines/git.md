...
<!-- image: activation-squashing.png "Activation of squashing in MR" -->
...
<!-- image: suggestions_bad.png "Bad suggestion commit message" -->
<!-- /admonition -->

<!-- admonition: tip Good -->
<!-- image: suggestions_good.png "Good suggestion commit message" -->
<!-- /admonition -->
...
<!-- image: multi-line-comments.png "Multi-line commit message example" -->

Results In:

<!-- image: result.png "Result in GitLab MR" -->
