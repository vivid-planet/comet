...
(async () => {
    await Promise.all([
        ...
        fs.promises.copyFile("demo/site-configs.d.ts", "demo/api/src/site-configs.d.ts"),
        fs.promises.copyFile("demo/site-configs.d.ts", "demo/admin/src/site-configs.d.ts"),
        fs.promises.copyFile("demo/site-configs.d.ts", "demo/site/src/site-configs.d.ts"),
    ]);
})();
