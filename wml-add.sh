...
echo $target
echo $source
packages=( file-icons material-ui-react-select react-admin-core react-admin-date-fns react-admin-final-form-material-ui react-admin-form react-admin-layout react-admin-mui react-admin-rte react-admin-i18n )
